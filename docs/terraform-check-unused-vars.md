...
> _a pre-commit hook for finding unused variables in terraform modules and removing them._

[Repo](https://github.com/mcole18/terraform-check-unused-variables)
